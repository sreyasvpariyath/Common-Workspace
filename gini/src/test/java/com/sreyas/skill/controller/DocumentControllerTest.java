...
import com.sreyas.skill.constants.Constants;
...
class DocumentControllerTest {
    ...
    void update() throws Exception {
        ...
        when(service.update(Mockito.anyLong(), any(UpdateDocument.class)))
                .thenReturn(updateModel.getDescription());
        ...
        mockMvc.perform(request)
                ...
                .andExpect(content().json("{\"data\":\"Bill of fuel\"}"))
                .andReturn();
    ...
    void updateWithWrongDesc() throws Exception {
        ...
        Set<ConstraintViolation<UpdateDocument>> violations = validator.validate(updateModel);
        when(service.update(Mockito.anyLong(), any(UpdateDocument.class)))
